...
const selector = `#contents > div.contentsArea.WeekMenu > div:nth-child(227) > ` +
                `div:nth-child(2) > table > tbody > tr:nth-child(1) > td:nth-child(${(today.getDay() + 4)}) > ul > li`;
                // 요일 테스트 하시려면 getDay의 반환값이 일요일(0) ~ 토요일(6)이기 때문에 생각해서 해주세요. (식단 리스트 3~7), 
